...
var getPayloadClient = function () {
    ...
    return __awaiter(void 0, __spreadArray([], args_1, true), void 0, function (_a) {
        var _b, e_1;
        var _c = _a === void 0 ? {} : _a, initOption = _c.initOption;
                ...
                case 0:
                    ...
                    if (!cached.promise) {
                        cached.promise = payload_1.default.init(__assign({ email: {
                            ...
                            }, secret: process.env.PAYLOAD_SECRET, local: (initOption === null || initOption === void 0 ? void 0 : initOption.express) ? false : true }, (initOption || {})));
                    }
                    _d.label = 1;
                case 1:
                    _d.trys.push([1, 3, , 4]);
